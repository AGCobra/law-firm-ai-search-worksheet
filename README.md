...
6. Download all runs as CSV for spreadsheet review. Download a runs backup as JSON before leaving, then import that backup on a later visit.
...
The included example CSV and checklist use illustrative estate-planning questions for Boston, MA. Their observation fields are blank; they contain no search results. These example downloads work without JavaScript. Personalized questions, recording, run comparison and backup/import require JavaScript.
